...
//menambahkan jumlah data laporan
...
<body id="page-top">
    ...
    <div id="wrapper">
        <!-- Sidebar -->
        <ul class="navbar-nav sidebar sidebar-dark accordion" id="accordionSidebar" style="background-color: #F96E2A;">
            <!-- Sidebar - Brand -->
                        ...
                        <div class="col-xl-12 col-lg-7">
                            <div class="card shadow mb-4">
                                ...
                                <div
                                    ...
                                    <h6 class="m-0 font-weight-bold text-dark">Laporan dalam proses</h6>
                                </div>
                                <!-- Card Body -->
                                <div class="card-body">

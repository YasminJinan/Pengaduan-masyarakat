...
// menyimpan siapa yg login
session_start();

include '../db/connect.php';
include '../function/pengaduan.php';

// cek yg login masyarakat/bukan
if ($_SESSION['role'] != 1) {
...
if (isset($_POST['submit'])) {
    ...
    //$image untuk menyimpan image yg diimput
    if (isset($_FILES['image']) & $_FILES['image']['error'] == 0) {
        $image = $_FILES['image']['name'];
        $tmp_name = $_FILES['image']['tmp_name'];
        //.. keluar dari folder masyarakat
        $target_dir = "../uploads/";
    ...
    //kalo nggak kosong masih bisa diisi
    if (!empty($report)) {
        ...
        if ($status) {
            ...
            echo "jika terjadi kesalahan, coba lagi";
        }
    } else {
        echo "masukkin datanyaw";
    }
}
   ...
   <div id="wrapper">
       ...
       <ul  class="navbar-nav bg-gradient-danger sidebar sidebar-dark accordion" id="accordionSidebar" >
           ...
           <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
               ...
               <div class="sidebar-brand-text mx-3">SiSolusi <sup></sup></div>
           </a>
                       ...
                       <div class="col-xl-8 col-lg-7">
                           <div class="card shadow mb-4">
                               ...
                               <div
                                   ...
                                   <h6 class="m-0 font-weight-bold text-dark">Harap lengkapi data yang diminta di bawah ini!</h6>

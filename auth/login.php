                        ...
                        <div class="card-body p-0">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6 d-none d-lg-block bg-login-image">
                                    <dotlottie-player src="https://lottie.host/08eb27b7-f9f0-4ad8-a8b6-23aeb6d686d6/hBNJzkO1Wy.json "
                                ...
                                <div class="col-lg-6">
                                    <div class="p-5">
                                        ...
                                        <form class="user" method="POST">
                                            ...
                                            <button type="submit" name="login" class="btn btn-danger btn-user btn-block">Login</button>
                                        </form>    
                                    </div>
                                </div>
                            </div>

...
// cek form apakah sudah terisi bekum
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    $feedback = $_POST['feedback'] ?? '';
    $petugas_id = $_SESSION['user_id']; //$_SESSION = user yg sedang login
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-dark sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
                ...
                <div class="sidebar-brand-text mx-3">SISolusi</div>
            </a>
    ...
    <div class="col-xl-12 col-lg-7">
        <div class="card shadow mb-4">
            ...
            <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                <h6 class="m-0 font-weight-bold text-dark">Form Tambah Feedback untuk laporan dengan ID <?= $report_id ?></h6>
            </div>
            <!-- Card Body -->
            <div class="card-body">
                <form method="POST">
                    <div class="mb-3">
                        ...
                        <textarea name="feedback" class="form-control" id="feedback" aria-describedby="emailHelp" placeholder="Masukkan Feedback anda"></textarea>
                        <div id="feedbackHelp" class="form-text"></div>
                    </div>
                    <button type="submit" class="btn btn-dark">Simpan feedback</button>
                </form>
            </div>
        </div>
    </div>
